...
1. Download the latest `SubVoice_Setup.exe` file.

1. Double-click the Setup file.

1. Follow the on-screen instructions and select **Install**.

1. Launch SubVoice from the Desktop shortcut or the Start Menu.
...
1. Tải file `SubVoice_Setup.exe` mới nhất.

1. Nhấp đúp vào file Setup.

1. Làm theo hướng dẫn trên màn hình và chọn **Install**.

1. Mở SubVoice từ biểu tượng trên Desktop hoặc trong Start Menu.
